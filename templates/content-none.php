...
<div class="col-sm-12 text-center">
	<h1 class="blog-item-title m-b-10"><?php esc_html_e( 'Nothing Found', 'education' ); ?></h1>

	<?php if ( is_home() && current_user_can( 'publish_posts' ) ) : ?>

	    <p><?php echo sprintf( __( 'Ready to publish your first post? <a href="%1$s">Get started here</a>.', 'education' ), esc_url( admin_url( 'post-new.php' ) ) ); ?></p>
	...
	<?php else : ?>
	    ...
	    <p><?php esc_html_e( 'It seems we can\'t find what you\'re looking for. Perhaps searching can help.', 'education' ); ?></p>
	    <?php get_search_form(); ?>
