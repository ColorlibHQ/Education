...
class education_recent_widget extends WP_Widget {
...
'education_recent_widget',


// Widget name will appear in UI
esc_html__( '[ Education ] Recent Post', 'education' ),

// Widget description
array( 'description' => esc_html__( 'Add recent post with thumbnail', 'education' ), )
);
...
echo $args['before_title'] . $title . $args['after_title'];
    ...
    <div class="single-post-list d-flex flex-row align-items-center">
        <div class="thumb">
            <?php
            the_post_thumbnail( 'education_widget_post_thumb', array( 'class' => 'img-fluid' ) );
            ?>
        </div>
        <div class="details">
...
if ( isset( $instance[ 'title' ] ) ) {
	...
	$title = esc_html__( 'Recent Post', 'education' );
}
//	
...
<p>
<label for="<?php echo $this->get_field_id( 'post_number' ); ?>"><?php _e( 'Posts Number:' ,'education'); ?></label>
...
} // Class education_recent_widget ends here


// Register and load the widget
function education_recent_post_load_widget() {
	register_widget( 'education_recent_widget' );
}
add_action( 'widgets_init', 'education_recent_post_load_widget' );