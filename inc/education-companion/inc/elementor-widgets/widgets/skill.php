 ...
 * @since 1.0
 */
class Education_Skill extends Widget_Base {
	...
	protected function _register_controls() {
        ...
        $this->start_controls_section(
            'skill_content',
            [
                'label' => __( 'Skill', 'education' ),
            ]
        );
        $this->add_control(
            'skill', [
                'label' => __( 'Create skill item', 'education' ),
