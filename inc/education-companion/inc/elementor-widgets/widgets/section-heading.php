 ...
 * @since 1.0
 */
class Education_sh extends Widget_Base {
	...
	public function get_title() {
		return __( 'Section Heading', 'education' );
	}
	...
	protected function _register_controls() {
        ...
        $this->start_controls_section(
            'sh_content',
            [
                'label' => __( 'Section Heading', 'education' ),
            ]
        );
        $this->add_control(
            'sh_sectiontitle',
        ...
        $this->add_control(
            'sh_sectionsubtitle',
            [
                'label'       => esc_html__( 'Sub Title', 'education' ),
                'label_block' => true,
                'type'        => Controls_Manager::TEXT,
            ]
        );
        ...
        $this->start_controls_section(
            'style_section', [
                'label' => __( 'Style Section', 'education' ),
