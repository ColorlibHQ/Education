...
class Education_Clients extends Widget_Base {

	public function get_name() {
		return 'education-clients';
	}

	public function get_title() {
		return __( 'Clients', 'education' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'clients_content',
			[
				'label' => __( 'Clients', 'education' ),
			]
		);
		$this->add_control(
            'clients', [
                'label' => __( 'Client', 'education' ),
                ...
                'fields' => [
                    ...
                    [
                        'name'  => 'url',
                        'label' => __( 'Client Url', 'education' ),
                        'type'  => Controls_Manager::TEXT,
                        'default' => '#'
                    ],
                    [
                        'name'  => 'img',
                        'label' => __( 'Client Logo', 'education' ),
