 ...
 * @since 1.0
 */
class Education_Accordion extends Widget_Base {

	public function get_name() {
		return 'education-accordion';
	}

	public function get_title() {
		return __( 'Accordion', 'education' );
	}
	...
	protected function _register_controls() {
        ...
        $this->start_controls_section(
            'accordion_heading',
            [
                'label' => esc_html__( 'Accordion Section Heading', 'education' ),
            ]
        );
        $this->add_control(
            'sect_title', [
		...
		$this->start_controls_section(
			'accordion_block',
			[
				'label' => esc_html__( 'Accordion', 'education' ),
			]
        );
        ...
        $this->start_controls_section(
            'section_video',
            [
                'label' => esc_html__( 'Vedio Settings', 'education' ),
            ]
        );
        $this->add_control(
            'accordion_video_url', [
                'label' => esc_html__( 'YouTube Vedio URL', 'education' ),
        ...
        $this->add_control(
            'paly_icon_select', [
                'label' => esc_html__( 'Vedio Play Icon Select', 'education' ),
        ...
        $this->add_control(
            'video_paly_icon', [
                'label' => esc_html__( 'Vedio Play Image Icon', 'education' ),
        ...
        $this->add_control(
            'video_paly_fonticon', [
                'label' => esc_html__( 'Vedio Play Font Icon', 'education' ),
        ...
        $this->start_controls_section(
            'style_accordion', [
                'label' => esc_html__( 'Style Accordin', 'education' ),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
        $this->add_control(
            'color_accordion_title', [
                'label'     => esc_html__( 'Accordion Title Color', 'education' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#000',
                'selectors' => [
        ...
        $this->add_control(
            'color_accordion_title_bg', [
                'label'     => esc_html__( 'Active Accordion Color', 'education' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#fff',
                'selectors' => [
        ...
        $this->add_control(
            'color_accordion_title_bg', [
                'label'     => esc_html__( 'Active Accordion Background Color', 'education' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#f7631b',
                'selectors' => [
        ...
        $this->add_control(
            'color_accordion_content', [
                'label'     => esc_html__( 'Accordion Content Color', 'education' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#777',
                'selectors' => [
                    ...
                    <div class="col-md-6 video-right justify-content-center align-items-center d-flex relative">
                        ...
                        <a class="play-btn" href="<?php echo esc_url( $videoUrl ) ?>">
                            ...
                            if( $settings['paly_icon_select'] == 'image_icon' ){
                                echo '<img src="'. esc_url( $playImgIcon ) .'" alt="'. esc_html__( 'Play Button', 'education' ) .'">';
                            }else{
