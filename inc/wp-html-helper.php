...
// image default alt
if( ! function_exists( 'education_img_default_alt' ) ) {
	function education_img_default_alt( $url = '' ) {
...
// Image Tag
if( ! function_exists( 'education_img_tag' ) ) {
	function education_img_tag( array $args ) {
		...
		if( ! empty( $args['alt'] ) ) {
			...
			$alt = education_img_default_alt( $url );
		}
...
// Anchor Tag
if( ! function_exists( 'education_anchor_tag' ) ) {
	function education_anchor_tag( array $args ) {
		
		$default = array(
			'url' 	 		=> '',
			'text' 	 		=> esc_html__( 'Click Here', 'education' ),
			'target' 		=> '',
			'title' 		=> '',
			'class'  		=> '',
			'id' 	 		=> '',
...
// Heading Tag
if( ! function_exists( 'education_heading_tag' ) ) {
	function education_heading_tag( array $args ) {
		
		$default = array(
			'tag' 	 	  => 'h1',
			'text' 	 	  => esc_html__( 'Write Something', 'education' ),
			'class'  	  => '',
			'id' 	 	  => '',
			'wrap_before' => '',
			'wrap_after'  => '',
...
// Paragraph Tag
if( ! function_exists( 'education_paragraph_tag' ) ) {
	function education_paragraph_tag( array $args ) {
...
// Other Tag
if( ! function_exists( 'education_other_tag' ) ) {
	function education_other_tag( array $args ) {
...
// Button Element 
if( ! function_exists( 'education_button_element ' ) ) {
	function education_button_element( array $args ) {
		
		$default = array(
			'text' 	 	  => esc_html__( 'Button', 'education' ),
			'type'   	  => '',
			'class'  	  => '',
			'id' 	 	  => '',
			'wrap_before' => '',
