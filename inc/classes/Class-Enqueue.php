...
class Education_Enqueue {

	public $scripts = array();

	public function education_scripts_enqueue_init() {
		add_action( 'wp_enqueue_scripts', array( $this, 'education_frontend_enqueue_scripts', ) );
	}

	public function education_frontend_enqueue_scripts( ) {
